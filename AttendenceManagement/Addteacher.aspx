<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addteacher.aspx.cs" Inherits="AttendenceManagement.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
                    ...
                    <ul class ="nav navbar-nav navbar-right">
                        ...
                        <li class ="drodown" >
                                     ...
                                     <ul class ="dropdown-menu">
                                         ...
                                         <li ><a href ="DisplayFeedback.aspx">Display All Feedback</a> </li>
        ...
        <!---navbar end--->
                ...
                <div align="center">
                <h1 align="center"><asp:Label ID="signup" runat="server" Text="ADD NEW TEACHER"></asp:Label></h1>
                <h6></h6>
                ...
                <div>
                    ...
                    <asp:TextBox ID="txtusername" runat="server" Width="786px" placeholder="Enter Teacher's username" CssClass="auto-style1"></asp:TextBox></h3>
                    
             
                    <h3><asp:Label ID="pass" runat="server" Text="Password    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="txtpass" runat="server" Width="786px" TextMode="Password" placeholder="Enter Teacher's Password" CssClass="auto-style1"></asp:TextBox>
                    
                </h3>
                        <h3><asp:Label ID="name" runat="server" Text="Full Name    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="txtname" runat="server" Width="786px" placeholder="Enter Teacher's Full Name" CssClass="auto-style1"></asp:TextBox>
                </h3>
                
                   <h3><asp:Label ID="regno" runat="server" Text="Registation Number    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="txtregno" runat="server" Width="800px" placeholder="Enter Teacher Registation Number" CssClass="auto-style1"></asp:TextBox>
                </h3>
                   <h3><asp:Label ID="phno" runat="server" Text="Phone Number    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="txtphno" runat="server" Width="786px" placeholder="Enter Teacher's Phone Number" CssClass="auto-style1"></asp:TextBox>
                </h3>
                   <h3><asp:Label ID="email" runat="server" Text="Email Id    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="txtemail" runat="server" Width="786px" placeholder="Enter Teacher's Email Id" CssClass="auto-style1" ></asp:TextBox>
                </h3>
                  
                    <h3><asp:Label ID="add1" runat="server" Text="Address 1    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="address" runat="server" Width="786px" placeholder="Enter Teacher's Address 1" CssClass="auto-style1"></asp:TextBox>
                </h3>
                
                   <h3><asp:Label ID="add2" runat="server" Text="Address 2    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="txtad2r" runat="server" Width="786px" Placeholder="Enter Teacher's Address2" CssClass="auto-style1"></asp:TextBox>
                </h3>
                   <h3><asp:Label ID="lblcity" runat="server" Text="City    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="txtcity" runat="server" Width="786px" placeholder="Enter Teacher's City" CssClass="auto-style1"></asp:TextBox>
                </h3>
                   <h3><asp:Label ID="lblDistrict" runat="server" Text="District    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="txtdist" runat="server" Width="786px" placeholder="Enter Teacher's District" CssClass="auto-style1" ></asp:TextBox>
                </h3>
                   <h3><asp:Label ID="lblpin" runat="server" Text="PinCode    " CssClass="text-success"></asp:Label><br /><br />
                    <asp:TextBox ID="txtpin" runat="server" Width="786px" placeholder="Enter Teacher's PinCode" CssClass="auto-style1" ></asp:TextBox>
                </h3>
